...
app.get("/executives/", function(req, res){
  res.render("eboardexecutive-team");
});
app.get("/executives", function(req, res){
  res.render("advisoryexecutive-team");
});
