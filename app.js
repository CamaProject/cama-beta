...
{name:"Simran", country:"Jamaica",position:"current", bio:" Simran is a Jamaican junior currently studying Psychology at New York University Abu Dhabi. Since she was fifteen, Simran has been involved in several community service initiatives geared towards helping youth in and outside of her country. Currently, her main interests lie within the fields of child development, education and psychology. She also loves to eat food from various cuisines, read novels in parks, take long walks, binge-watch shows on Netflix and of course, nap. She is very excited to be a part of the CAMA team and cannot wait to share some of her knowledge about the college admissions process.",image:"/img/mentors/currentMentors/Simran.jpeg"},


{name:"Juria", country:"Japan - Nepal",position:"current", bio:"Juria is a Japanese-Nepali junior at NYU Abu Dhabi. She calls Japan and Nepal her home but has studied and lived in London and the UAE. While she spent her childhood growing up on the seashore of Chiba, she did most of her schooling in the small city of Kathmandu. At NYU Abu Dhabi, she is currently studying Economics and enjoys learning topics in public policy and development. She is also an environment enthusiast and hopes to minor in Environmental Studies. Beyond academics, she is passionate about, and committed to serving the community. At NYU Abu Dhabi, she conducts various recreational and educational activities for domestic migrant workers in Abu Dhabi. In Japan, she works as a camp counselor in a summer camp, promoting English learning environment while enjoying the outdoors for young children. She was also a CAMA mentor last year and loved sharing her experiences and learnings with her mentee.  In her free time, she enjoys being outdoors and always seeks to try out new adventures; traveling and exploring new cultures has been a favorite part of it. She has always had an interest in trekking in the mountains of Nepal, mountain biking through rocky trails, climbing steep rocks, bouldering, and trying out new cuisines. ",image:"/img/mentors/currentMentors/Juria.jpeg"},
...
{name:"Kristos", country:"Ghana",position:"current", bio:"Kristos is a rising sophomore specializing in cognitive sciences in Biology and a minor in Psychology. He reflects a varied personality of openness and conscientiousness and enjoys music, dancing and debating a lot. As a member of the global community in NYUAD, he is intrigued by how language came to be a defining human characteristic. He is passionate about solving global issues with identity and public health and wants to be a multilingual.",image:"/img/mentors/currentMentors/Kristos.jpg"}
